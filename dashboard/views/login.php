...
<head>
	<meta charset="UTF-8">
	<title>San Salvador | Inicio de sesion</title>
						...
						<div class="form-container">
							<div class="form-group">
								<div class="form-group">
									...
									<input class="form-control" type="text" autocomplete="off" id="email"/>
								</div>	
							</div>
							<div class="form-group">
								<div class="form-group">
							...
							<div class="text-center">
								<button class="btn btn-outline-secondary" id="btn-login">Entrar</button>
							</div>
						</div>
					</div>
					<div class="col-md-3"></div>
